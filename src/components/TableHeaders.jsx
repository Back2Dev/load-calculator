...
const TableHeaders = () => {
    ...
    return (
        <>
            <Box backgroundColor={theme.palette.primary.main} width='100%' height='fit-content' px={4} pt={2} pb={1} sx={{ flexGrow: 1 }}>
            ...
            <Box backgroundColor={theme.palette.secondary.main} width='100%' height='3px' px={4} py={0} sx={{ flexGrow: 1 }}>
            </Box>
        </>
    )
}
